...
(101, 0, 'auth:manage', '权限管理', 'Access Control', 1, 'Monitor', '/auth', null, 1, null),
(102, 101, 'auth:user', '用户管理', 'Admin Users', 2, 'Menu', '/auth/user', 'auth/UserManageView', 1, null),
(103, 101, 'auth:role', '角色管理', 'Roles', 2, 'Menu', '/auth/role', 'auth/RoleManageView', 2, null),
(104, 101, 'auth:perm', '权限菜单', 'Permissions', 2, 'Menu', '/auth/perm', 'auth/MenuManageView', 3, null);
